        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4 col-md-6">
            <article>
              ...
              <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center">DevRook</li>
                  <li class="d-flex align-items-center"><i class="bi bi-dot"></i> <time datetime="2022-01-01">2025 11 24</time></li>
                </ul>
              </div>

              <h2 class="title">게이머들을 위한 추천 PC</h2>
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <article>
              ...
              <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center">Eden</li>
                  <li class="d-flex align-items-center"><i class="bi bi-dot"></i> <time datetime="2022-01-01">2025 11 20</time></li>
                </ul>
              </div>

              <h2 class="title">컴퓨터 구매를 처음해보는 초보자들을 위한 팁</h2>
          ...
          <div class="col-lg-4 col-md-6">
            ...
            <article>
              ...
              <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center">Rune</li>
                  <li class="d-flex align-items-center"><i class="bi bi-dot"></i><time datetime="2022-01-01">2025 11 16</time></li>
                </ul>
              </div>

              <h2 class="title">컴퓨터가 느려졌을 때 해결법</h2>
  ...
  <div class="container">
    <div class="d-flex justify-content-center">
      ...
      <!-- [!] 기존 html 파일로 연결된 걸 jsp 파일로 변경함. -->
        ...
        <li><a href="blog.jsp" class="active">1</a></li>
